 ...
 *
 * It is adapted by @atelierfabien to prevent node_modules from being skipped:
 * https://github.com/vercel/next.js/blob/canary/packages/next/build/webpack/plugins/jsconfig-paths-plugin.ts
 */
      ...
      webpack(config, options) {
        ...
        if (plugin) {
          config.resolve.plugins.splice(
            config.resolve.plugins.indexOf(plugin),
            1,
            new TsConfigPathsPlugin(plugin.paths, plugin.resolvedBaseUrl)
          );
        }
